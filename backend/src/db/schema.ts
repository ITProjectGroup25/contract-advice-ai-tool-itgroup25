...
export const orgUnit = pgTable("org_unit", {
	...
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "org_unit_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("idx_org_unit_type_active").using("btree", table.unitType.asc().nullsLast().op("bool_ops"), table.active.asc().nullsLast().op("bool_ops")),
	foreignKey({
...
export const grantScheme = pgTable("grant_scheme", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "grant_scheme_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	code: varchar({ length: 50 }),
	name: varchar({ length: 200 }),
	active: boolean().default(true).notNull(),
	orderIndex: integer("order_index").default(100).notNull(),
}, (table) => [
	unique("grant_scheme_code_key").on(table.code),
]);

export const form = pgTable("form", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "form_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	...
	unique("form_form_key_key").on(table.formKey),
]);

export const formSection = pgTable("form_section", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "form_section_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const exportJob = pgTable("export_job", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "export_job_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	...
	index("idx_export_filter").using("btree", table.formId.asc().nullsLast().op("date_ops"), table.workflowType.asc().nullsLast().op("date_ops"), table.dateFrom.asc().nullsLast().op("enum_ops"), table.dateTo.asc().nullsLast().op("date_ops")),
	index("idx_export_status_time").using("btree", table.status.asc().nullsLast().op("enum_ops"), table.createdAt.asc().nullsLast().op("enum_ops")),
	foreignKey({
			columns: [table.formId],
			foreignColumns: [form.id],
			name: "fk_export_form"
...
export const person = pgTable("person", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "person_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	name: varchar({ length: 200 }),
...
export const question = pgTable("question", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "question_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	formId: bigint("form_id", { mode: "number" }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("idx_question_form_order").using("btree", table.formId.asc().nullsLast().op("int4_ops"), table.orderIndex.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.formId],
			foreignColumns: [form.id],
...
export const validationRule = pgTable("validation_rule", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "validation_rule_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("idx_vrule_question").using("btree", table.questionId.asc().nullsLast().op("int4_ops"), table.orderIndex.asc().nullsLast().op("int4_ops")),
	foreignKey({
...
export const guidanceSearchLog = pgTable("guidance_search_log", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "guidance_search_log_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("idx_gslog_created").using("btree", table.createdAt.asc().nullsLast().op("timestamp_ops")),
	foreignKey({
...
export const questionOption = pgTable("question_option", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "question_option_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	questionId: bigint("question_id", { mode: "number" }).notNull(),
...
export const branchRule = pgTable("branch_rule", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "branch_rule_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	questionId: bigint("question_id", { mode: "number" }).notNull(),
	...
	index("idx_brule_question").using("btree", table.questionId.asc().nullsLast().op("int4_ops"), table.orderIndex.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.questionId],
			foreignColumns: [question.id],
...
export const submission = pgTable("submission", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "submission_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	...
	index("idx_submission_form_time").using("btree", table.formId.asc().nullsLast().op("timestamp_ops"), table.createdAt.asc().nullsLast().op("int8_ops")),
	index("idx_submission_type_time").using("btree", table.workflowType.asc().nullsLast().op("enum_ops"), table.createdAt.asc().nullsLast().op("timestamp_ops")),
	foreignKey({
			columns: [table.formId],
			foreignColumns: [form.id],
...
export const submissionStatusHistory = pgTable("submission_status_history", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "submission_status_history_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("idx_status_sub_time").using("btree", table.submissionId.asc().nullsLast().op("int8_ops"), table.changedAt.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.submissionId],
			foreignColumns: [submission.id],
...
export const consentLog = pgTable("consent_log", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "consent_log_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	submissionId: bigint("submission_id", { mode: "number" }).notNull(),
	policyVersion: varchar("policy_version", { length: 50 }),
	acceptedAt: timestamp("accepted_at", { mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	ipAddress: varchar("ip_address", { length: 45 }),
	userAgent: varchar("user_agent", { length: 400 }),
}, (table) => [
	index("idx_consent_submission").using("btree", table.submissionId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.submissionId],
			foreignColumns: [submission.id],
...
export const answer = pgTable("answer", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "answer_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	submissionId: bigint("submission_id", { mode: "number" }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	questionId: bigint("question_id", { mode: "number" }).notNull(),
	...
	index("idx_answer_submission").using("btree", table.submissionId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.questionId],
			foreignColumns: [question.id],
...
export const attachment = pgTable("attachment", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "attachment_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	submissionId: bigint("submission_id", { mode: "number" }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const emailMessage = pgTable("email_message", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "email_message_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	submissionId: bigint("submission_id", { mode: "number" }).notNull(),
	...
	index("idx_email_status_next").using("btree", table.status.asc().nullsLast().op("timestamp_ops"), table.nextAttemptAt.asc().nullsLast().op("timestamp_ops")),
	index("idx_email_submission").using("btree", table.submissionId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.submissionId],
			foreignColumns: [submission.id],
...
export const adminUser = pgTable("admin_user", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "admin_user_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
...
export const emailTemplate = pgTable("email_template", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "email_template_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	formId: bigint("form_id", { mode: "number" }),
...
export const guidanceBinding = pgTable("guidance_binding", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "guidance_binding_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	formId: bigint("form_id", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	questionId: bigint("question_id", { mode: "number" }).notNull(),
...
export const guidanceResource = pgTable("guidance_resource", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "guidance_resource_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
...
export const guidanceTrigger = pgTable("guidance_trigger", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "guidance_trigger_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	formId: bigint("form_id", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	questionId: bigint("question_id", { mode: "number" }),
...
export const submissionDraft = pgTable("submission_draft", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "submission_draft_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	formId: bigint("form_id", { mode: "number" }).notNull(),
...
export const submissionDraftAnswer = pgTable("submission_draft_answer", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "submission_draft_answer_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
...
export const knowledgeBase = pgTable("knowledge_base", {
	...
	index("kb_embedding_ivfflat_cos").using("ivfflat", table.embedding.asc().nullsLast().op("vector_cosine_ops")).with({lists: "128"}),
	index("knowledge_base_embedding_ivfflat_cos").using("ivfflat", table.embedding.asc().nullsLast().op("vector_cosine_ops")).with({lists: "100"}),
...
export const formDefaultRecipient = pgTable("form_default_recipient", {
	...
	primaryKey({ columns: [table.formId, table.email], name: "form_default_recipient_pkey"}),
]);
...
export const submissionDraftAnswerMulti = pgTable("submission_draft_answer_multi", {
	...
	primaryKey({ columns: [table.draftAnswerId, table.itemValue], name: "submission_draft_answer_multi_pkey"}),
]);
...
export const answerMultiValue = pgTable("answer_multi_value", {
	...
	primaryKey({ columns: [table.answerId, table.itemValue], name: "answer_multi_value_pkey"}),
]);
...
export const adminUserRole = pgTable("admin_user_role", {
	...
	primaryKey({ columns: [table.adminUserId, table.roleName], name: "admin_user_role_pkey"}),
]);
...
export const emailAttachmentMap = pgTable("email_attachment_map", {
	...
	primaryKey({ columns: [table.emailId, table.attachmentId], name: "email_attachment_map_pkey"}),
]);
...
export const validationRuleParam = pgTable("validation_rule_param", {
	...
	primaryKey({ columns: [table.ruleId, table.paramKey], name: "validation_rule_param_pkey"}),
]);
