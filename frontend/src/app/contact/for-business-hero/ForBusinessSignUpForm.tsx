  ...
  return (
    <Card className="w-full rounded-2xl bg-white border-none pb-8 shadow-2xl lg:flex-[2_2_0%] lg:px-8">
      ...
      <CardContent className="flex justify-center">
        <Link
          href="/grant-support"
          className="flex justify-center w-full p-4 font-bold text-white bg-purple-500 rounded-full shadow-xl text-md hover:bg-purple-600 hover:opacity-90 transition-all"
        >
