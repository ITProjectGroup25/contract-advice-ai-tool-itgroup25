...
const EMAILJS_CONFIG = {
  ...
  grantTeamTemplateId: process.env.NEXT_PUBLIC_EMAILJS_GRANT_TEAM_TEMPLATE_ID || 'grant_team_template_id'
};
...
class EmailService {
  ...
  async sendCustomEmail(templateParams: Record<string, any>, templateId?: string): Promise<boolean> {
    if (!this.initialized) {
      console.warn('⚠️ EmailJS not initialized');
      return false;
    }
